...
<ctrl:form >
  <ctrl:hidden property="lng_id"/>
  <table class=formBack align="center"><tr><td >
  <table cellspacing="2"  >
    <tr>
      <td><bean:message key="Language.lng_name"/></td>
      <td><ctrl:text property="lng_name"/></td>
    </tr>
    <tr>
      <td><bean:message key="Language.lng_letter_id"/></td>
      <td><ctrl:text property="lng_letter_id"/></td>
    </tr>
    <tr>
