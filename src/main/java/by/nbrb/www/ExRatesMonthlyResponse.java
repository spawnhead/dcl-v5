...
public class ExRatesMonthlyResponse  implements java.io.Serializable {
    private by.nbrb.www.ExRatesMonthlyResponseExRatesMonthlyResult exRatesMonthlyResult;

    public ExRatesMonthlyResponse() {
    }

    public ExRatesMonthlyResponse(
           by.nbrb.www.ExRatesMonthlyResponseExRatesMonthlyResult exRatesMonthlyResult) {
     ...
     */
    public by.nbrb.www.ExRatesMonthlyResponseExRatesMonthlyResult getExRatesMonthlyResult() {
        return exRatesMonthlyResult;
    }
     ...
     */
    public void setExRatesMonthlyResult(by.nbrb.www.ExRatesMonthlyResponseExRatesMonthlyResult exRatesMonthlyResult) {
        this.exRatesMonthlyResult = exRatesMonthlyResult;
    }
