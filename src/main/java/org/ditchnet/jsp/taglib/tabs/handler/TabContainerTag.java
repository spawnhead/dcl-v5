...
public final class TabContainerTag extends SimpleTagSupport
{
  ...
  public void setDefaultSelectedTab(String defaultSelectedTab)
  {
  ...
  public void doTag() throws JspException, IOException
  {
    ...
    for (Iterator iter = children.iterator(); iter.hasNext();)
    {
      ...
      if (!StringUtil.isEmpty(tabPane.getTabTitle()))
      {
        tabTitle = StrutsUtil.getMessage(pageContext, tabPane.getTabTitle());
      }
      if (!StringUtil.isEmpty(tabTitle))
      {
        out.text(tabTitle);
      }
      out.text(" ");
    ...
    if ( !StringUtil.isEmpty(getDefaultSelectedTab()) )
    {
      out.text("<script language=\"JScript\" type=\"text/javascript\">\n" +
              "  org.ditchnet.jsp.TabUtils.selectPanelById(\"" + getDefaultSelectedTab() + "\");\n" +
              "</script>");
    }
