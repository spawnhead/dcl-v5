...
public class FilesPathsForm extends BaseForm
{
  HolderImplUsingList gridFilesPaths = new HolderImplUsingList();

  public HolderImplUsingList getGridFilesPaths()
  {
    return gridFilesPaths;
  }

  public void setGridFilesPaths(HolderImplUsingList gridFilesPaths)
  {
    this.gridFilesPaths = gridFilesPaths;
  }

  static public class FilesPath
  {
    String flp_id;
