 ...
 * Time: 5:37:29 PM
 */
public class MontageAdjustmentsForm extends BaseForm
{
  protected static Log log = LogFactory.getLog(MontageAdjustmentsForm.class);

  StuffCategory stuffCategory = new StuffCategory();
  HolderImplUsingList grid = new HolderImplUsingList();

  public MontageAdjustmentsForm()
  {
  }
  ...
  {
    return !StringUtil.isEmpty(stuffCategory.getId());
  }

  static public class MontageAdjustment
  {
    String number;
    String mad_id;
    ...
    private String getInnerClass1(String type)
    {
      if ( StringUtil.isEmpty(mad_annul) )
      {
        return "grid-row-inner" + type;
      }

      return "grid-row-inner" + type + "-crossed";
    }
    ...
    public String getMad_work_type()
    {
      ...
      try
      {
        workType += "<table cellSpacing=0 cellPadding=0 border=0 width='100%' class='grid'><tr class='" + getInnerClass1("1") + "'><td>";
        workType += StrutsUtil.getMessage(context, "MontageAdjustments.mad_work_type1");
        workType += "</td></tr>";
        workType += "<tr class='" + getInnerClass1("2") + "'><td>";
        workType += StrutsUtil.getMessage(context, "MontageAdjustments.mad_work_type2");
    ...
    public String getFormattedString(double mechSum, double elSum)
    {
      ...
      formattedString += "<table cellSpacing=0 cellPadding=0 border=0 width='100%' class='grid'><tr class='" + getInnerClass1("1") + "'><td align='right'>";
      formattedString += StringUtil.double2appCurrencyStringByMask(mechSum, "##0.0");
      formattedString += "</td></tr>";
      formattedString += "<tr class='" + getInnerClass1("2") + "'><td align='right'>";
    ...
    public String getFormattedStringItog(double mechSum, double elSum)
    {
      ...
      workSum += "<table cellSpacing=0 cellPadding=0 border=0 width='100%' class='grid'><tr class='" + getInnerClass1("1") + " dark'><td align='right'>";
      workSum += StringUtil.double2appCurrencyStringByMask(mechSum, "##0.0");
      workSum += "</td></tr>";
      workSum += "<tr class='" + getInnerClass1("2") + " dark'><td align='right'>";
