...
public class ProducesForAssembleMinskForm extends BaseDispatchValidatorForm
{
  String cpr_id;
  String name_filter;
  String ctn_number;
  ...
  public boolean isCleanRight()
  {
    return cleanRight;
  }

  public void setCleanRight(boolean cleanRight)
  {
    this.cleanRight = cleanRight;
  }
  ...
  public HolderImplUsingList getReservedInfoLines()
  {
    return reservedInfoLines;
  }

  public void setReservedInfoLines(HolderImplUsingList reservedInfoLines)
  {
    this.reservedInfoLines = reservedInfoLines;
  }
}