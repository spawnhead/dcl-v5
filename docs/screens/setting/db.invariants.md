# setting — DB invariants (enforced only)
...
### Table `DCL_SETTING`
- Columns (type): `STN_ID` INTEGER NOT NULL; `STN_NAME` VARCHAR(100) NOT NULL; `STN_DESCRIPTION` VARCHAR(256); `STN_VALUE` VARCHAR(1000); `STN_TYPE` SMALLINT NOT NULL; `STN_ACTION` VARCHAR(100); `STN_VALUE_EXTENDED` VARCHAR(1000)
- NOT NULL: `STN_ID`, `STN_NAME`, `STN_TYPE`
- Foreign Keys: UNKNOWN/none detected in direct parse for this table.
- Check Constraints: UNKNOWN/none detected.
- Trigger Logic: `DCL_SETTING_BI0`
