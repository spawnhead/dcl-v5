# specificationimportpositions (slug: `specificationimportpositions`) — Legacy Screen Spec

## 1) Вход в экран
- Primary JSP source: `src/main/webapp/jsp/SpecificationImportPositions.jsp`.
